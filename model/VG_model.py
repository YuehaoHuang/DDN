...
class VG_model(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.resnet_feature_extractor = AutoFeatureExtractor.from_pretrained("./pretrained_model/resnet-18")
        self.resnet = ResNetForImageClassification.from_pretrained("./pretrained_model/resnet-18").to(args.device)
